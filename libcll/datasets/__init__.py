...
def prepare_dataloader(
    ...
    if dataset == "mnist":
    ...
    elif dataset == "aclmicro_imagenet10":
        train_transform = transforms.Compose(
            [
                transforms.RandomCrop(64, padding=8),
                transforms.RandomHorizontalFlip(),
        ...
        train_set = ACLMicro_ImageNet10(
            root="./data/imagenet10",
            train=True,
            transform=train_transform,
            num_cl=num_cl,
        )
        test_set = ACLMicro_ImageNet10(
            root="./data/imagenet10",
            train=False,
            transform=test_transform,
            num_cl=num_cl,
    ...
    elif dataset == "aclmicro_imagenet20":
        train_transform = transforms.Compose(
            [
                transforms.RandomCrop(64, padding=8),
                transforms.RandomHorizontalFlip(),
        ...
        train_set = ACLMicro_ImageNet20(
            root="./data/imagenet20",
            train=True,
            transform=train_transform,
            num_cl=num_cl,
        )
        test_set = ACLMicro_ImageNet20(
            root="./data/imagenet20",
            train=False,
            transform=test_transform,
            num_cl=num_cl,
    ...
    if transition_matrix == "noisy":
        Q = get_transition_matrix("strong", train_set.num_classes, seed=seed)
    return (
        train_loader,
        valid_loader,
        test_loader,
