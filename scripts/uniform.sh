...
conda activate cll
python /work/u8273333/format.py ${strategy}-${tp} ${output_dir}
echo "Start"
cd /work/u8273333/libcll/
for seed in ${seeds[@]}; do
	echo /work/u8273333/libcll/scripts/run_all_experiments_seed.sh ${strategy} ${tp} ${seed}
	/work/u8273333/libcll/scripts/run_all_experiments_seed.sh ${strategy} ${tp} ${seed} &
done
wait
echo "End"
