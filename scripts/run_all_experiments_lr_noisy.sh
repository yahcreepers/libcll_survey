...
#strategies=("SCL")
datasets=("mnist" "kmnist" "fmnist" "yeast" "texture" "control" "dermatology" "micro_imagenet10" "micro_imagenet20" "clmicro_imagenet10" "clmicro_imagenet20" "cifar10" "cifar20" "clcifar10" "clcifar20")
